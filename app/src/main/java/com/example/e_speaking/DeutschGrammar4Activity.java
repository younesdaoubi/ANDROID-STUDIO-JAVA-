...
public class DeutschGrammar4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar4);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit1 = findViewById(R.id.de_display_msg4);
        ...
        Intent intent = new Intent (this, DeutschGrammar5Activity.class);
