...
public class EnglishGrammar2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_grammar2);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit2 = findViewById(R.id.de_display_msg2);
        String text2 = tonEdit2.getText().toString();
        responsesList.add(text2);


        Intent intent = new Intent(this, EnglishGrammar3Activity.class);
