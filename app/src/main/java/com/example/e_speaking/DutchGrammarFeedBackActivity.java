...
public class DutchGrammarFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dutch_grammar_feed_back);
        String [] responses = {"ben","heb","heeft","hebben","zijn","is","heeft"};
        ...
        final TextView textView22 = (TextView) findViewById(R.id.TextViewDuAnimal22);
        ...
        final TextView textView66 = (TextView) findViewById(R.id.TextViewDuAnimal66);
        final TextView textView7 = (TextView) findViewById(R.id.TextViewDuAnimal7);
    ...
    public void openDutchlishMenu(View view){

        startActivity(new Intent(this, DutchMenu.class));
    }

    public void openDutchlishex(View view){

        startActivity(new Intent(this,DutchGrammarMenuActivity.class));
    }
}
