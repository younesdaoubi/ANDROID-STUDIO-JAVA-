...
public class EnglishGrammarFeedBackActivity extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_english_grammar_feed_back);
        //correction de l'exercice
        String [] responses = {"am","have","is","is","are","am","are"};
