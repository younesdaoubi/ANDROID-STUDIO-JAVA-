...
public class DeutschMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deutsch_menu);

        cardView = (CardView) findViewById(R.id.buttonMapDeutsch);
        ...
        String url = "https://countries.craftypixels.com/v2/lang/de";
...
// Add the request to the RequestQueue.
    ...
    public void openDeutschListening(View view){

        startActivity(new Intent(this,DeutschListeningMenuActivity.class));
    }

    public void openDeutschGrammar(View view){

        startActivity(new Intent(this,DeutschGrammarMenuActivity.class));
    }

    public void openDeutschVocabulary(View view){
