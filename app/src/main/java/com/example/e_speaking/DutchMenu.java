...
public class DutchMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dutch_menu);

        cardView = (CardView) findViewById(R.id.buttonMapDutch);
        ...
        String url = "https://countries.craftypixels.com/v2/lang/nl";
...
// Add the request to the RequestQueue.
    ...
    public void openDutchListening(View view){

        startActivity(new Intent(this,DutchListeningMenuActivity.class));
    }

    public void openDutchGrammar(View view){

        startActivity(new Intent(this,DutchGrammarMenuActivity.class));
    }

    public void openDutchVocabulary(View view){
