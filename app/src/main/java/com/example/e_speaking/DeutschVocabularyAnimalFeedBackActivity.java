...
public class DeutschVocabularyAnimalFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_vocabulary_animal_feed_back);


        String[] responses = {"Löwe", "giraffe","katze", "fisch","zebra","hund","hai"};
        //correction de l'exercice
        ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesDeAnimal");
        ...
        String text ="";
        final TextView textView8 = (TextView) findViewById(R.id.TextViewDeAnimal8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewDeAnimal1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewDeAnimal11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewDeAnimal2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewDeFruit22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewDeAnimal3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewDeAnimal33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewDeAnimal4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewDeAnimal44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewDeAnimal5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewDeAnimal55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewDeAnimal6);
        ...
        final TextView textView77 = (TextView) findViewById(R.id.TextViewDeAnimal77);
        final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewDeAnimalTitle);
