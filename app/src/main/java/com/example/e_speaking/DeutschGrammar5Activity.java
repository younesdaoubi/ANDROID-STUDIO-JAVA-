...
public class DeutschGrammar5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar5);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit1 = findViewById(R.id.de_display_msg5);
        ...
        Intent intent = new Intent (this, DeutschGrammar6Activity.class);
