...
public class DeutschGrammar3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar3);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit1 = findViewById(R.id.de_display_msg3);
        ...
        Intent intent = new Intent (this, DeutschGrammar4Activity.class);
