...
public class FrancaisGrammar3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_francais_grammar3);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit2 = findViewById(R.id.fr_display_msg3);
        String text2 = tonEdit2.getText().toString();
        responsesList.add(text2);


        Intent intent = new Intent(this, FrancaisGrammar4Activity.class);
