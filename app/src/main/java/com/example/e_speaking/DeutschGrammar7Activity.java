...
public class DeutschGrammar7Activity extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar7);
    ...
    public void sendMessageGramDe(View view){
        ...
        Intent intent = new Intent (this, DeutschGrammarFeedBackActivity.class);
