...
public class DeutschGrammarFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar_feed_back);

        String [] responses = {"bin","haben","ist","bist","sind","bin","sind"};
        ...
        String text ="";
        final TextView textView8 = (TextView) findViewById(R.id.TextViewDe8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewDe1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewDe11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewDe2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewDe22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewDe3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewDe33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewDe4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewDe44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewDe5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewDe55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewDe6);
        final TextView textView66 = (TextView) findViewById(R.id.TextViewDe66);
        final TextView textView7 = (TextView) findViewById(R.id.TextViewDe7);
        final TextView textView77 = (TextView) findViewById(R.id.TextViewDe77);
        final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewDeTitle);
    ...
    public void openDeutschlishMenu(View view){

        startActivity(new Intent(this, DeutschMenu.class));
    }

    public void openDeustchlishex(View view){

        startActivity(new Intent(this,DeutschGrammarMenuActivity.class));
    }
}
