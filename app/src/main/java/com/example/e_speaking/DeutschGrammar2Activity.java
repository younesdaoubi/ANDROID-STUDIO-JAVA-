...
public class DeutschGrammar2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_grammar2);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit1 = findViewById(R.id.de_display_msg2);
        ...
        Intent intent = new Intent (this, DeutschGrammar3Activity.class);
