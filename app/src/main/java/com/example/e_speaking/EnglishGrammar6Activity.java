...
public class EnglishGrammar6Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_english_grammar6);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit6 = findViewById(R.id.de_display_msg6);
        String text6 = tonEdit6.getText().toString();

        responsesList.add(text6);
...
*/
        ...
        Intent intent = new Intent (this, EnglishGrammar7Activity.class);
