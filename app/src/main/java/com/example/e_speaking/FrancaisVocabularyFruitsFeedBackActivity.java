...
public class FrancaisVocabularyFruitsFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_francais_vocabulary_fruits_feed_back);


        String[] responses = {"raisins", "fraise","pêche", "pastèque","banane","pomme","cerise"};
        //correction de l'exercice
        ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesFrFruits");
        ...
        String text ="";
        final TextView textView8 = (TextView) findViewById(R.id.TextViewFrFruit8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewFrFruit1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewFrFruit11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewDeFruit2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewFrFruit22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewFrFruit3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewFrFruit33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewEnFruit4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewFrFruit44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewFrFruit5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewFrFruit55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewFrFruit6);
        final TextView textView66 = (TextView) findViewById(R.id.TextViewFrFruit66);
        final TextView textView7 = (TextView) findViewById(R.id.TextViewFrFruit7);
        final TextView textView77 = (TextView) findViewById(R.id.TextViewFrFruit77);
        final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewFrFruitTitle);
    ...
    public void openFrancaisex(View view){
        ...
        startActivity(new Intent(this,FrancaisVocabularyMenuActivity.class));
    }
}
