...
public class DutchListeningEx1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dutch_listening_ex1);

        this.seekBar = (SeekBar) findViewById(R.id.sound_bar);

        this.mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.dutch_sound_1);
    ...
    public void openFrancaisQuiz1(View view){
        ...
        mediaPlayer.pause();
        startActivity(new Intent(this,DutchQuizActivity.class));
    }
