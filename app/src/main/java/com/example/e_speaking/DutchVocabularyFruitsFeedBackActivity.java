...
public class DutchVocabularyFruitsFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dutch_vocabulary_fruits_feed_back);

        String[] responses = {"druiven", "aardbei","perzik", "watermeloen","banaan","appel","kers"};
        ...
        final TextView textView8 = (TextView) findViewById(R.id.TextViewDuFruit8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewDuFruit1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewDuFruit11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewDuFruit2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewDuFruit22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewDuFruit3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewDuFruit33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewDuFruit4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewDuFruit44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewDuFruit5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewDuFruit55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewDuFruit6);
        ...
        final TextView textView77 = (TextView) findViewById(R.id.TextViewDuFruit77);
        final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewDuFruitTitle);
        ...
        if(responsesTab[0].equals(responses[0]))
        {
            ...
            textView1.setText("niet geantwoord");
        ...
        if(responsesTab[1].equals(responses[1])){
            ...
            textView2.setText("niet geantwoord");
        ...
        if(responsesTab[2].equals(responses[2])){
            ...
            textView3.setText("niet geantwoord");
        ...
        if(responsesTab[3].equals(responses[3])){
            ...
            textView4.setText("niet geantwoord");
        ...
        if(responsesTab[4].equals(responses[4])){
            ...
            textView5.setText("niet geantwoord");
        ...
        if(responsesTab[5].equals(responses[5])){
            ...
            textView6.setText("niet geantwoord");
        ...
        if(responsesTab[6].equals(responses[6])){
            ...
            textView7.setText("niet geantwoord");
