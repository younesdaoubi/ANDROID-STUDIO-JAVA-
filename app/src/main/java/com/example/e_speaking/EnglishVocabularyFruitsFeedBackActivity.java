...
public class EnglishVocabularyFruitsFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_english_vocabulary_fruits_feed_back);

        String[] responses = {"grapes", "strawberry","peach", "watermelon","banana","apple","cherry"};
        //correction de l'exercice
        ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesEnFruits");
        ...
        String text ="";
        final TextView textView8 = (TextView) findViewById(R.id.TextViewEnFruit8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewEnFruit1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewEnFruit11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewEnFruit2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewEnFruit22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewEnFruit3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewEnFruit33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewEnFruit4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewEnFruit44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewEnFruit5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewEnFruit55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewEnFruit6);
        final TextView textView66 = (TextView) findViewById(R.id.TextViewEnFruit66);
        final TextView textView7 = (TextView) findViewById(R.id.TextViewEnFruit7);
        final TextView textView77 = (TextView) findViewById(R.id.TextViewEnFruit77);
        final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewEnFruitTitle);
    ...
    public void openEnglishex(View view){

        startActivity(new Intent(this,EnglishVocabularyMenuActivity.class));
    }
    public void openEnglishMenu(View view){
