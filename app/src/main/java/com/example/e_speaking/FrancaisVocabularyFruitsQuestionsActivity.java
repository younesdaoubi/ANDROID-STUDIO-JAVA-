...
public class FrancaisVocabularyFruitsQuestionsActivity extends AppCompatActivity {

    ArrayList<String> responsesFrFruits = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_francais_vocabulary_fruits_questions);
    ...
    public void sendResponses(View view){
        ...
        EditText tonEdit1 = findViewById(R.id.Frr_responses_fruits1);
        String text1 = tonEdit1.getText().toString();

        EditText tonEdit2 = findViewById(R.id.Frr_responses_fruits2);
        ...
        EditText tonEdit4 = findViewById(R.id.Frr_responses_fruits4);
        ...
        responsesFrFruits.add(text1);
        responsesFrFruits.add(text2);
        responsesFrFruits.add(text3);
        responsesFrFruits.add(text4);
        responsesFrFruits.add(text5);
        responsesFrFruits.add(text6);
        responsesFrFruits.add(text7);
        ...
        Intent intent = new Intent (this, FrancaisVocabularyFruitsFeedBackActivity.class);
           /* intent.putExtra("EXTRA_MESSAGE2", text2);
            intent.putExtra("EXTRA_MESSAGE3", text3);
            intent.putExtra("EXTRA_MESSAGE4", text4);
            intent.putExtra("EXTRA_MESSAGE5", text5);
            intent.putExtra("EXTRA_MESSAGE6", text6);
            intent.putExtra("EXTRA_MESSAGE7", text7);*/
        intent.putExtra("responsesFrFruits", responsesFrFruits);
