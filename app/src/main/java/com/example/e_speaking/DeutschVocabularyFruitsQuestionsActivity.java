...
public class DeutschVocabularyFruitsQuestionsActivity extends AppCompatActivity {

    ArrayList<String> responsesDeFruits = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_vocabulary_fruits_questions);
    ...
    public void sendResponses(View view){
        ...
        responsesDeFruits.add(text1);
        responsesDeFruits.add(text2);
        responsesDeFruits.add(text3);
        responsesDeFruits.add(text4);
        responsesDeFruits.add(text5);
        responsesDeFruits.add(text6);
        responsesDeFruits.add(text7);
        ...
        Intent intent = new Intent (this, DeutschVocabularyFruitsFeedBackActivity.class);
           /* intent.putExtra("EXTRA_MESSAGE2", text2);
            intent.putExtra("EXTRA_MESSAGE3", text3);
            intent.putExtra("EXTRA_MESSAGE4", text4);
            intent.putExtra("EXTRA_MESSAGE5", text5);
            intent.putExtra("EXTRA_MESSAGE6", text6);
            intent.putExtra("EXTRA_MESSAGE7", text7);*/
        intent.putExtra("responsesDeFruits", responsesDeFruits);
