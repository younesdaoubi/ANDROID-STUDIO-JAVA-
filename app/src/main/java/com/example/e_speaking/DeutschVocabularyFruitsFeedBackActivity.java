...
public class DeutschVocabularyFruitsFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deutsch_vocabulary_fruits_feed_back);

    String[] responses = {"weintrauben", "erdbeere","pfirsich", "wassermelone","banane","apfel","kirsche"};
    //correction de l'exercice
    ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesDeFruits");
    ...
    String text ="";
    final TextView textView8 = (TextView) findViewById(R.id.TextViewDeFruit8);
    final TextView textView1 = (TextView) findViewById(R.id.TextViewDeFruit1);
    final TextView textView11 = (TextView) findViewById(R.id.TextViewDeFruit11);
    final TextView textView2 = (TextView) findViewById(R.id.TextViewDeFruit2);
    final TextView textView22 = (TextView) findViewById(R.id.TextViewDeFruit22);
    final TextView textView3 = (TextView) findViewById(R.id.TextViewDeFruit3);
    final TextView textView33 = (TextView) findViewById(R.id.TextViewDeFruit33);
    final TextView textView4 = (TextView) findViewById(R.id.TextViewDeFruit4);
    final TextView textView44 = (TextView) findViewById(R.id.TextViewDeFruit44);
    final TextView textView5 = (TextView) findViewById(R.id.TextViewDeFruit5);
    final TextView textView55 = (TextView) findViewById(R.id.TextViewDeFruit55);
    final TextView textView6 = (TextView) findViewById(R.id.TextViewDeFruit6);
    final TextView textView66 = (TextView) findViewById(R.id.TextViewDeFruit66);
    final TextView textView7 = (TextView) findViewById(R.id.TextViewDeFruit7);
    final TextView textView77 = (TextView) findViewById(R.id.TextViewDeFruit77);
    final TextView textViewDeFruitTitle = (TextView) findViewById(R.id.textViewDeFruitTitle);
    ...
    if(responsesTab[0].equals(responses[0]))
    {
        ...
        textView1.setText("nicht beantwortet");
    ...
    if(responsesTab[1].equals(responses[1])){
        ...
        textView2.setText("nicht beantwortet");
    ...
    if(responsesTab[2].equals(responses[2])){
        ...
        textView3.setText("nicht beantwortet");
    ...
    if(responsesTab[3].equals(responses[3])){
        ...
        textView4.setText("nicht beantwortet");
    ...
    if(responsesTab[4].equals(responses[4])){
        ...
        textView5.setText("nicht beantwortet");
    ...
    if(responsesTab[5].equals(responses[5])){
        ...
        textView6.setText("nicht beantwortet");
    ...
    if(responsesTab[6].equals(responses[6])){
        ...
        textView7.setText("nicht beantwortet");
    ...
    public void openDeutschMenu(View view){

        startActivity(new Intent(this,DeutschMenu.class));
    }

    public void openDeutschex(View view){

        startActivity(new Intent(this,DeutschVocabularyMenuActivity.class));
    }
