...
public class FrancaisVocabularyAnimalFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_francais_vocabulary_animal_feed_back);

        String[] responses = {"lion", "girafe","chat", "poisson","zèbre","chien","requin"};
        //correction de l'exercice
        ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesFrAnimal");
        ...
        String text ="";
        final TextView textView8 = (TextView) findViewById(R.id.TextViewFrAnimal8);
        final TextView textView1 = (TextView) findViewById(R.id.TextViewFrAnimal1);
        final TextView textView11 = (TextView) findViewById(R.id.TextViewFrAnimal11);
        final TextView textView2 = (TextView) findViewById(R.id.TextViewFrAnimal2);
        final TextView textView22 = (TextView) findViewById(R.id.TextViewFrFruit22);
        final TextView textView3 = (TextView) findViewById(R.id.TextViewFrAnimal3);
        final TextView textView33 = (TextView) findViewById(R.id.TextViewFrAnimal33);
        final TextView textView4 = (TextView) findViewById(R.id.TextViewFrAnimal4);
        final TextView textView44 = (TextView) findViewById(R.id.TextViewFrAnimal44);
        final TextView textView5 = (TextView) findViewById(R.id.TextViewFrAnimal5);
        final TextView textView55 = (TextView) findViewById(R.id.TextViewFrAnimal55);
        final TextView textView6 = (TextView) findViewById(R.id.TextViewFrAnimal6);
        ...
        final TextView textView77 = (TextView) findViewById(R.id.TextViewFrAnimal77);
