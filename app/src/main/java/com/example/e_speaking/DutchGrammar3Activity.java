...
public class DutchGrammar3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dutch_grammar3);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit2 = findViewById(R.id.du_display_msg3);
        String text2 = tonEdit2.getText().toString();
        responsesList.add(text2);


        Intent intent = new Intent(this, DutchGrammar4Activity.class);
