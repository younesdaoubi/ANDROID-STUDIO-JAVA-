...
public class FrancaisMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView = (CardView) findViewById(R.id.buttonMapFr);
        ...
        String url = "https://countries.craftypixels.com/v2/lang/fr";
...
// Add the request to the RequestQueue.
    ...
    public void openFrancaisListening(View view){

        startActivity(new Intent(this,FrancaisListeningMenuActivity.class));
    }

    public void openFrancaisGrammar(View view){

        startActivity(new Intent(this,FrancaisGrammarMenuActivity.class));
    }

    public void openFrancaisVocabulary(View view){
