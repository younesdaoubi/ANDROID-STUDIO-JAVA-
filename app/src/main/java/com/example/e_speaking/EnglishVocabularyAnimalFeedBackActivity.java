...
public class EnglishVocabularyAnimalFeedBackActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_english_vocabulary_animal_feed_back);

        String[] responses = {"lion", "giraffe","cat", "fish","zebra","dog","shark"};
        //correction de l'exercice
        ArrayList<String> responsesList = (ArrayList<String>) getIntent().getSerializableExtra("responsesEnAnimal");
