...
public class DutchGrammar2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dutch_grammar2);
    ...
    public void sendMessageGramEn(View view){
        ...
        EditText tonEdit2 = findViewById(R.id.du_display_msg2);
        String text2 = tonEdit2.getText().toString();
        responsesList.add(text2);


        Intent intent = new Intent(this, DutchGrammar3Activity.class);
